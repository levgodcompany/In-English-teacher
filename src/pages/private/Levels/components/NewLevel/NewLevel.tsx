...
const NewLevel: React.FC<NewLevelProps> = ({ close, idTypeLevel }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      api.setUrl(`/${idTypeLevel}`)
      await api.create<levelCreateDto>(formData);
      setFormData({
        description: "",
        order: 0,
        title: "",
    ...
    <div className={style.container}>
      ...
      <form className={style.form} onSubmit={handleSubmit}>
        ...
        <div className={style.container_buttons}>
          <button onClick={() => close()} className={style.submitButton}>
            Cerrar
          </button>
